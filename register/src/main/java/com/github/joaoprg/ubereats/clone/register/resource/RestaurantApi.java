...
@RolesAllowed("owner")
@SecurityScheme(securitySchemeName = "uber-eats-clone-oauth", type = SecuritySchemeType.OAUTH2, flows = @OAuthFlows(password = @OAuthFlow(tokenUrl = "http://localhost:8181/realms/uber-eats-clone/protocol/openid-connect/token")))
...
public interface RestaurantApi {
    ...
    @APIResponses(value = {
            @APIResponse(
                    ...
                    content = @Content(
                            mediaType = MediaType.APPLICATION_JSON,
                            schema = @Schema(ref = "restaurant_list"))
            ),
            @APIResponse(
                    name = "badRequest",
                    responseCode = "400",
